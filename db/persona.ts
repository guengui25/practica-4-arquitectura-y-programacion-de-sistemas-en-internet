...
import { Persona } from "../types.ts"; //Importo el tipo de dato que voy a usar
...
export default mongoose.model<PersonaModelType>("personas", PersonaSchema); //Exporto el modelo de datos de la plantilla en la base de datos
